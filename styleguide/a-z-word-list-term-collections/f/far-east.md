\<div class="noscriptTag"\>Your browser does not support JavaScript. Please enable the Javascript.\</div\>

Loading...

![Microsoft Logo](./far-east_files/ms_logo.png "Style guides")
...
[Sign out](https://worldready.cloudapp.net/Account/SignOut "sign out")

  - [Home](https://worldready.cloudapp.net/ "Home")
  - [Style guides](https://worldready.cloudapp.net/StyleGuide/List "Style guides")
  - [Regional formats](https://worldready.cloudapp.net/MarketReadiness/Locale "Regional formats")

[![FAQ](./far-east_files/help.png "FAQ")](https://worldready.blob.core.windows.net/document/FAQ.pdf "FAQ")
[![Email](./far-east_files/message.png "Send feedback")](mailto:msstyle@microsoft.com?subject=Style%20guide%20feedback&body=Style%20guide%20topic%20\(URL\)%3A%0A%0AYour%20team%3A%20%0A%0ADescribe%20the%20issue%3A "Send feedback")

[Home](https://worldready.cloudapp.net/ "Home")
[Search style guides](https://worldready.cloudapp.net/StyleGuide/List "Search style guides")
[View style guide](https://worldready.cloudapp.net/Styleguide/Read?id=2700&topicid=33731# "View style guide")

Microsoft Writing Style Guide

-----

![Menu](./far-east_files/menu-normal.png)
...
![Menu](./far-east_files/menu-expand.png)
...
![Download](./far-east_files/Download.png)
...
![Copy URL](./far-east_files/Copy.png)
Copy URL
...
![In progress](./far-east_files/activity-large.gif)

URL :

[Microsoft Data Protection Notice](http://aka.ms/Lsipdh "Microsoft Data Protection Notice")
...
Do not send material from this site to any third party
